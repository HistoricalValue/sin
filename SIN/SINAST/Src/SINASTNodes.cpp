...
namespace SIN{
	...
	SINASTNODE_DEFAULT_NODE_DEFS_WITH_TYPE(Block			, SINASTNODES_BLOCKASTNODE_TYPE          )
	...
	SINASTNODE_DEFAULT_NODE_DEFS_WITH_TYPE(Function			, SINASTNODES_FUNCTIONASTNODE_TYPE       )
	SINASTNODE_DEFAULT_NODE_DEFS_WITH_TYPE(LamdaFunction	, SINASTNODES_FUNCTIONASTNODE_TYPE		 )
	SINASTNODE_DEFAULT_NODE_DEFS_WITH_TYPE(FormalArguments	, SINASTNODES_FORMALARGUMENTSASTNODE_TYPE)
