...
namespace SIN{
	...
	public:
		...
		PRESERVE_AST_EVALUATION_VISITOR_SIGNATURE(ForPreamble		) ;
		PRESERVE_AST_EVALUATION_VISITOR_SIGNATURE(ForAddendum		) ;
		...
		PRESERVE_AST_EVALUATION_VISITOR_SIGNATURE(Not				) ;
